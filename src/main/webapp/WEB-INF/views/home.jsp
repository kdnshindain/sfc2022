    ...
    <div class="body-wrap boxed-container">
        <header class="site-header">
			<div class="header-shape header-shape-1">
				<svg width="237" height="222" viewBox="0 0 337 222" xmlns="http://www.w3.org/2000/svg">
				    <defs>
            ...
            <section class="hero">
                <div class="container">
                    <div class="hero-inner">
						<div class="hero-copy">
							<p class="hero-paragraph">경제적 에너지 운영을 위한</p>
	                        <h1 class="hero-title mt-0">발전원가 전망 서비스</h1>
						</div>
